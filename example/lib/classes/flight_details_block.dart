...
class FlightDetailsBlock {
  ...
  void updateWith({Airport? departure, Airport? arrival, FlightClass? flightClass, FlightType? flightType, Aircraft? aircraft}) {
    Flight newValue = flightSubject.value.copyWith(departure: departure, arrival: arrival, flightClass: flightClass, flightType: flightType, aircraft: aircraft);
